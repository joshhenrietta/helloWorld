...
with app.app_context():
    ...
    users = [
        {'username': 'jhenriet', 'email': 'jhenriet@umd.edu', 'first_name':'Joshua', 'last_name':'Henrietta',
            'password': generate_password_hash('jhenriet', method='pbkdf2:sha256'), 'role':'STUDENT'},
